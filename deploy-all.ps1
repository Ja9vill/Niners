...
if (-not $Force) {
    ...
    try {
        ...
        Write-Host "  Non-interactive mode — proceeding automatically." -ForegroundColor Green
    }
}
...
# ============================================================
# PHASE 3: GIT — STAGE, COMMIT, PULL, PUSH
# ============================================================
...
if ($LASTEXITCODE -ne 0) {
    Write-ErrorMsg "Pull/rebase failed — possible conflicts:"
