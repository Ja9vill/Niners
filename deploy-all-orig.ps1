...
if (-not $Force) {
    ...
    try {
        ...
        Write-Host "  Non-interactive mode G현 proceeding automatically." -ForegroundColor Green
    }
}
...
# ============================================================
# PHASE 3: GIT G현 STAGE, COMMIT, PULL, PUSH
# ============================================================
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Warning "Nothing to commit G현 working tree clean"
} else {
...
if ($LASTEXITCODE -ne 0) {
    Write-ErrorMsg "Pull/rebase failed G현 possible conflicts:"
...
if ($LASTEXITCODE -eq 0) {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Warning "Tag created locally but push failed G현 push manually: git push origin $tagName"
    }
} else {
    Write-Warning "Failed to create deploy tag G현 continuing anyway"
}

# ============================================================
# PHASE 4: FIREBASE DEPLOY G현 HOSTING
# ============================================================
