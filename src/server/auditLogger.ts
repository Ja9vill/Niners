...
export function logAuthEvent(
  ...
  status: "SUCCESS" | "FAILURE",
  ipAddress: string,
  failureReason?: "INVALID_FORMAT" | "USER_NOT_FOUND" | "INACTIVE_ACCOUNT" | "INCORRECT_PASSWORD" | "TOKEN_CREATION_FAILED" | "RATE_LIMIT_BLOCKED" | "RATE_LIMIT_TRIGGERED" | "INTERNAL_ERROR" | "RESET_PASSWORD_REQUIRED"
) {
