...
export const AgencyPolicy = () => {
  return (
    <div className="w-full min-h-screen bg-[#0A0A0F] text-[#F0EFE8] flex flex-col items-center px-4 py-20 overflow-hidden relative">
      {/* Background Orbs */}
      ...
      <div className="max-w-4xl w-full mx-auto space-y-8 animate-fadeIn z-10">
        ...
        <div className="space-y-6">
          ...
          <div className="glass-card space-y-6 p-6 sm:p-8 rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-2xl">
            <h2 className="font-black text-xl text-[#D4AF37] flex items-center gap-3 border-b border-white/5 pb-4 uppercase tracking-wider">
              <Heart size={20} />
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-3">
                <h3 className="font-bold text-white text-sm uppercase tracking-widest">Kindness</h3>
              ...
              <div className="space-y-3">
                <h3 className="font-bold text-white text-sm uppercase tracking-widest">Unity</h3>
                <ul className="space-y-3 text-sm text-[#A09E9A] leading-relaxed list-disc list-inside">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="glass-card space-y-4 p-6 sm:p-8 rounded-3xl border border-[#D4AF37]/20 bg-gradient-to-br from-[#D4AF37]/5 to-transparent backdrop-blur-2xl">
              ...
              <div className="bg-black/30 p-4 rounded-xl border border-[#D4AF37]/30 mt-4">
                <h3 className="text-[10px] font-black uppercase tracking-widest text-[#D4AF37] mb-2 text-center">Current Agency Task</h3>
          ...
          <div className="glass-card space-y-4 p-6 sm:p-8 rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-2xl">
            ...
            <div className="p-4 bg-indigo-500/10 border border-indigo-500/20 rounded-xl">
              <h3 className="font-bold text-indigo-300 text-xs uppercase tracking-widest mb-2">Why is this required?</h3>
          ...
          <div className="glass-card space-y-4 p-6 sm:p-8 rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-2xl">
            ...
            <div className="space-y-4 text-sm text-white/80">
              <div className="bg-white/5 p-4 rounded-xl border border-white/5">
                <h3 className="font-bold text-[#D4AF37] mb-2 uppercase tracking-wide">Releasing Period</h3>
              ...
              <div className="bg-white/5 p-4 rounded-xl border border-white/5">
                <h3 className="font-bold text-[#D4AF37] mb-2 uppercase tracking-wide">Steps for Release</h3>
          ...
          <div className="text-center p-8">
            <h3 className="text-xl font-black text-white uppercase tracking-wider mb-2">Support Policy</h3>
