            ...
            {isPostingAnnouncement ? (
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <p className="text-[7px] font-black uppercase tracking-wider text-white/20 select-none border-b border-white/5 pb-1">MESSAGES & ACTION ITEMS</p>
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <aside className={cn(
          ...
          <div className="p-4 border-t border-white/5 space-y-1">
            <Link
              to="/learning?tab=onboarding"
              onClick={() => setIsSidebarOpen(false)}
              className={cn(
                "flex items-center gap-3 px-3 py-3 rounded-xl transition-all font-bold text-sm",
                location.pathname.startsWith('/learning') && location.search.includes('tab=onboarding')
                  ? "bg-[#D4AF37]/10 text-[#D4AF37] shadow-[inset_0_0_12px_rgba(212,175,55,0.05)]" 
                  : "text-[#A09E9A] hover:bg-white/[0.02] hover:text-[#F0EFE8]"
              )}
            >
