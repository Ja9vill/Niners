...
const getTierFilterStyle = (tierInput: string, isSelected: boolean) => {
  ...
  // Default fallback
  return "bg-[#D4AF37]/20 text-[#D4AF37] border-[#D4AF37]/50 shadow-[0_0_10px_rgba(212,175,55,0.2)]";
};
...
export const RosterTab: React.FC<RosterTabProps> = ({ isReadOnly = false }) => {
  ...
  return (
    <div className="space-y-6 relative roster-container">
      <style>{`
        .roster-filter-card {
          border-color: rgba(212, 175, 55, 0.28) !important;
          box-shadow: 0 12px 45px rgba(0, 0, 0, 0.85), 0 0 35px rgba(212, 175, 55, 0.09) !important;
        }
        /* Scoped select element styling for consistency */
        .roster-container select {
          border-color: rgba(212, 175, 55, 0.25) !important;
        }
        .roster-container select:focus {
          border-color: rgba(212, 175, 55, 0.6) !important;
          box-shadow: 0 0 0 3px rgba(212, 175, 55, 0.08) !important;
        }
      `}</style>
      {/* FILTER MENU BLOCKS */}
      <div className="roster-filter-card bg-[#000000]/75 backdrop-blur-xl p-5 rounded-2xl border border-[#D4AF37]/20 shadow-[0_0_50px_rgba(212,175,55,0.08)] flex flex-col gap-4 relative overflow-hidden">
        ...
        <div className="flex flex-row gap-3 items-center z-10 w-full">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="pl-9 pr-4 py-3 bg-black/30 border border-white/10 rounded-xl text-xs text-[#F0EFE8] focus:outline-none focus:border-[#D4AF37]/50 focus:bg-black/50 transition-all w-full shadow-inner"
            />
          </div>
          ...
          <div className="w-32 sm:w-48 shrink-0">
            <select
              ...
              className="w-full py-3 px-4 bg-[#000000]/90 border border-[#D4AF37]/20 rounded-xl text-xs text-[#F0EFE8] outline-none focus:border-[#D4AF37]/50 focus:bg-black/50 transition-all cursor-pointer shadow-inner font-bold"
            >
              <option value="all" className="bg-[#000000] text-[#F0EFE8]">All Members</option>
              <option value="hosts" className="bg-[#000000] text-[#F0EFE8]">Hosts</option>
              <option value="team_leaders" className="bg-[#000000] text-[#F0EFE8]">Team Leaders</option>
            </select>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                {host.photoUrl ? (
                  ...
                  <div className="absolute inset-0 flex items-center justify-center text-[#A09E9A]/20 bg-gradient-to-br from-[#000000] to-[#000000]" style={{ zIndex: 0 }}>
