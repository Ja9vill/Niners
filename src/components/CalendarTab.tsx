                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                          ...
                          <div className="flex flex-col gap-1">
                            <span className="text-xs font-black text-[#FF8C00] uppercase tracking-widest">{format(new Date(spotlightEvent.date), 'MMMM dd, yyyy')}</span>
                            <span className="text-sm font-black text-transparent bg-clip-text bg-gradient-to-r from-[#FFD700] to-[#FF8C00]">
                              {(() => {
                                ...
                                return formatDualTimestamps(displayTime, spotlightEvent.date);
                              })()}
                            </span>
                          </div>
                        </div>
                      ...
                      {spotlightEvent.participants && spotlightEvent.participants.length > 0 && (
                        <div className="mt-2">
                          <h5 className="text-[9px] font-black text-[#D4AF37] uppercase tracking-widest mb-3 border-b border-white/5 pb-2">
                            Performers / Hosts ({spotlightEvent.participants.length})
                          </h5>
